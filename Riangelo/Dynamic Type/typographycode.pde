...
void setup(){
  ...
  deutschlander = createFont("Deutschlander-Ow5e.ttf", fontSize);
  ...
  I = new Letter("I", normalChangeSpeed, 128);
  ...
  N = new Letter("N", int(normalChangeSpeed * 0.3), 80);
  ...
  N2 = new Letter("N", int(normalChangeSpeed * 0.7), 80);
  ...
  O = new Letter("O", int(normalChangeSpeed * 0.9), 110);
  ...
  T = new Letter("T", normalChangeSpeed, 80);
  ...
  I2 = new Letter("I", normalChangeSpeed, 120);
  ...
  O2 = new Letter("O", int(normalChangeSpeed * 0.5), 70);
  ...
  N3 = new Letter("N", normalChangeSpeed, 128);
